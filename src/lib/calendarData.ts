...
export const CALENDAR: Event[] = [
    ...
    lineup: [
      {
        ...
        name: "La Bruja",
        origin: "México",
        bio: "México City-born selector and producer known for weaving together cumbia sonidera with contemporary club sounds. Resident at Carmela since 2022, she has become one of the most sought-after DJs in Amsterdam's underground circuit. Her mixes are dense, referential, and always in motion.",
      ...
      },
      {
        ...
        name: "Teto Calypso",
        origin: "Brasil",
        bio: "São Paulo native blending baile funk rhythms with electronic production. Has released on Berlin-based labels and toured extensively across Europe, bringing favela sounds to club floors from Berghain to De School. A true boundary-crosser between worlds.",
  ...
  },
  {
    ...
    date: "2026-05-19",
    venue: "OCCII Amsterdam",
    description:
      "A vinyl-only afternoon session celebrating the physical format and the art of the dig. DJs bring rare Latin pressings and forgotten gems from across the continent. No laptops, no USB sticks — only wax, warmth, and stories.",
    flyer: "/images/events/carmela-fugaris.png",
    tags: ["Vinyl only", "Free entry", "Afternoon"],
    lineup: [
      {
        id: "nina-verde",
        name: "Niña Verde",
  ...
  },
  {
    ...
    venue: "Shelter Amsterdam",
    description:
      "Carmela Collective and Stadsfreug present a night of Afro-Latin sounds, bringing together the Rotterdam and Amsterdam underground scenes. A meeting point between diaspora histories and club futures.",
    flyer: "/images/events/ddm-25.png",
    ticketUrl: "https://shelter.nl",
    tags: ["DJ set", "Collaboration"],
    lineup: [
      {
        id: "axe-santos",
        name: "Axé Santos",
